...
namespace _GameFolder.Scripts.GridSystem
{
    public class MatchFinder : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _rowCount = _dataManager.AllLevels.LevelList[_dataManager.AllLevels.activeLevel].RowCount;
            _columnCount = _dataManager.AllLevels.LevelList[_dataManager.AllLevels.activeLevel].ColumnCount;
        }
        ...
        public void FindAllMatches()
        {
            for (int x = 0; x < _rowCount; x++)
            {
                for (int y = 0; y < _columnCount; y++)
                {
                    ...
                    {
                        if (x > 0 && x < _rowCount - 1) // Yatay eşleşme var mı diye kontrol
                        {
                        ...
                        if (y > 0 && y < _columnCount - 1) // Dikey eşleşme var mı diye kontrol
                        {
            ...
            for (int x = 0; x < _rowCount; x++)
            {
                for (int y = 0; y < _columnCount; y++)
                {
                    ...
                    else if (nullCounter > 0)
                    {
                        ...
                        fruit.name = "Fruit : " + fruitPos.x + ", " + newFruitPosY;
